...
const CURATED_TOP_VIDEOS = [
  ...
  {
    videoId: "NcCYq3bvlJM",
    title: "Devara Part 1 - Official Theatrical Trailer | Jr NTR | Janhvi Kapoor | Anirudh Ravichander",
  ...
  {
    videoId: "q8M6Ybjr2Wc",
    title: "Guntur Kaaram - Official Trailer | Mahesh Babu | Sreeleela | Thaman S",
    description: "Superstar Mahesh Babu and Sreeleela set the screen on fire in Trivikram's mass entertainer Guntur Kaaram, composed by S Thaman.",
  ...
  {
    videoId: "OXe7N7-xMKM",
    title: "Game Changer - Official Teaser (Telugu) | Ram Charan | Kiara Advani | Shankar | Thaman S",
    description: "Mega Power Star Ram Charan and Kiara Advani in Director Shankar's high-octane political action drama Game Changer.",
